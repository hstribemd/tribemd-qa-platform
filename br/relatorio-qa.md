...
Data da execução: 27/06/2026, 16:51:17

## Resumo executivo

Durante a execução foram analisadas 0 páginas e registrados 64 defeitos. Distribuição por severidade: 4 crítico(s), 47 alto(s), 7 médio(s) e 6 baixo(s).
...
- Origem: https://tribemd.com/br/coberturas/esmo-2025/
- Passos para reproduzir:
  1. Acessar https://tribemd.com/br/coberturas/esmo-2025/
...
- Origem: https://tribemd.com/br/coberturas/esmo-2025/
- Passos para reproduzir:
  1. Abrir https://tribemd.com/br/coberturas/esmo-2025/
...
### BUG-019 — Link quebrado (404) — perfil
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-020 — Link quebrado (404) — coverages
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-021 — Link quebrado (500) — busqueda
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-022 — Link quebrado (500) — search
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-023 — Link quebrado (500) — busqueda
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-026 — Link quebrado (500) — search
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-032 — Link quebrado (500) — busqueda
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-033 — Link quebrado (500) — search
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-035 — Link quebrado (500) — busqueda
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-036 — Link quebrado (500) — search
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-040 — Link quebrado (500) — busqueda
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-041 — Link quebrado (500) — search
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-043 — Link quebrado (500) — busqueda
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-044 — Link quebrado (500) — por que dois estudos com a mesma medicação podem ter resultados diferentes
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-045 — Link quebrado (500) — será que este estudo é confiável
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-047 — Link quebrado (500) — busqueda
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-049 — Link quebrado (500) — esc® 2025 – parachute hf: novo marco para o tratamento da insuficiência cardíaca
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-050 — Link quebrado (500) — search
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-051 — Link quebrado (500) — busqueda
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-052 — Link quebrado (500) — search
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-054 — Link quebrado (500) — search
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-055 — Link quebrado (500) — busqueda
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-056 — Link quebrado (500) — search
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-057 — Link quebrado (500) — busqueda
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-058 — Link quebrado (500) — busqueda
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-062 — Link quebrado (500) — world symposium 2026: perspectivas clínicas e experiências reais no tratamento d
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-063 — Link quebrado (500) — world symposium 2026 – mucopolissacaridoses: terapias com alcance ao sistema ner
- Severidade: **High** (alto)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link interno e chega a uma pagina com erro.
...
### BUG-002 — Página muito lenta em /br/ (8386ms)
- Severidade: **Medium** (médio)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: A página demora demais para ficar utilizável; o usuário pode desistir.
...
### BUG-004 — Página muito lenta em /br/eventos/ (8069ms)
- Severidade: **Medium** (médio)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: A página demora demais para ficar utilizável; o usuário pode desistir.
- Observado: Página levou 8069ms para estabilizar (limite: 8000ms)
...
### BUG-006 — Página muito lenta em /br/cursos/ (8081ms)
- Severidade: **Medium** (médio)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: A página demora demais para ficar utilizável; o usuário pode desistir.
- Observado: Página levou 8081ms para estabilizar (limite: 8000ms)
...
### BUG-007 — Página muito lenta em /br/sobre/ (8083ms)
- Severidade: **Medium** (médio)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: A página demora demais para ficar utilizável; o usuário pode desistir.
- Observado: Página levou 8083ms para estabilizar (limite: 8000ms)
...
### BUG-008 — Página muito lenta em /br/perguntas-frequentes/ (8169ms)
- Severidade: **Medium** (médio)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: A página demora demais para ficar utilizável; o usuário pode desistir.
- Observado: Página levou 8169ms para estabilizar (limite: 8000ms)
...
### BUG-005 — Link externo quebrado no rodape (999): https://www.linkedin.com/company/tribemd-br/posts/?feedView=all
- Severidade: **Low** (baixo)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link do site para um destino de terceiros que respondeu com erro. Fora do controle do TribeMD; verificar manualmente.
...
### BUG-059 — Link externo quebrado (999) — posts
- Severidade: **Low** (baixo)
- Locale: BR | Viewport: desktop-chromium
...
### BUG-060 — Link externo quebrado (400) — tribemd.br
- Severidade: **Low** (baixo)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link para um site de terceiros que respondeu com erro.
- Observado: HTTP 400 ao acessar https://www.facebook.com/tribemd.br/
...
### BUG-061 — Link externo quebrado (400) — cookies
- Severidade: **Low** (baixo)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link para um site de terceiros que respondeu com erro.
...
### BUG-064 — Link externo quebrado (522) — https://mediq.com.br/
- Severidade: **Low** (baixo)
- Locale: BR | Viewport: desktop-chromium
- Impacto ao usuário: O usuario clica num link para um site de terceiros que respondeu com erro.
